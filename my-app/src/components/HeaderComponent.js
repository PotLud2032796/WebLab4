...
import personnage from '../Ressources/Personnage.png';
...
function HeaderComponent(props) {
    ...
    {/* IMAGE LOGO */}
    <img src={logo} className="img-fluid col-lg-2 col-8 mt-2"/>
    ...
    {/* IMAGE PERSONNAGE */}
    <img src={personnage} className="img-fluid col-lg-2 col-0 d-none d-lg-block"/>
    </div>
    </div>
}
